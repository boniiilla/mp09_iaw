...
<head>
    ...
    <style>
        ...
        .form_clubes label, .form_clubes input {
            margin-bottom: 10px;
            margin-top: 10px;
            font-family: "Jockey One", sans-serif;
        }
...
<body>
    <header>
        ...
        <div class="buttons">
            <input type="button" class="button" value="Añadir Equipo"/>
    ...
    <div class="container">
        ...
        <div class="form_clubes">
            <form action="add_clubes.php" method="POST">
                ...
                <input type="text" name="presidente" id="presidente" required>
                <label for="entrenador">Entrenador:</label>
                <input type="text" name="entrenador" id="entrenador" required>
                <label for="escudo">Escudo:</label>
                <input type="text" name="escudo" id="escudo" required>
